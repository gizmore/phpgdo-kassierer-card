...
# Redeem Now
	'msg_redeem_started' => 'Sie fordern das Angebot jetzt an!',	'kk_info_redeem_offer_now' => 'Sie <b>entweder</b>Lassen Sie den Arbeiter bei %s die OK-Taste drücken,
...
# Partner Redeem
	'mt_kassierercard_partnerredeemqrcode' => 'Einlösecode scannen',	'kk_info_redeem_qr' => 'Als Partner scannen Sie hier den QR-Code eines Kunden.',	
# Redeem O.K.
	'kk_info_redeem_offer_ok' => 'Lassen Sie den Arbeiter bei %s jetzt den Knopf drücken!',	'msg_offer_redeemed_ok' => 'Sie haben dieses Angebot offiziell eingelöst: %s.<br/>Wenn dies ein Fehler ist: Pech!',	
# Granted
...
# Redeem Mails
	'mailsubj_redeemed_staff' => '%s: Angebot eingelöst',	'mailbody_redeemed_staff' => 'Hallo %s,Der Benutzer %s hat gerade das folgende Angebot eingelöst:
...
Das %s-System',
	...
	'mailsubj_redeemed_user' => '%s: Angebot eingelöst',	'mailbody_redeemed_user' => 'Hallo %s,Sie haben gerade %s Sterne für das folgende Angebot eingelöst:
...
Das %s-System',
	...
	'mailsubj_redeemed_partner' => '%s: Angebot eingelöst',	'mailbody_redeemed_partner' => 'Hallo %s,Der Benutzer %s hat gerade eines Ihrer Angebote eingelöst:
...
# Entered stars
	'mail_subj_customer_stars' => '%s: %s Sterne verdient',	'mail_body_customer_stars' => 'Hallo %s,Der Benutzer %s hat gerade Ihren Coupon von %s Sternen eingegeben.
